...
<head>
    ...
    <title>Its Fashion | @yield('titulo', 'Mi Cuenta')</title>
            ...
            <ul class="navbar-nav ml-auto flex items-center gap-3">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a href="#" class="dropdown-item" onclick="event.preventDefault(); document.getElementById('logout-form-cli').submit();">
                            <i class="fas fa-sign-out-alt mr-2"></i> Cerrar Sesión
                        </a>
                        <form id="logout-form-cli" action="{{ route('logout') }}" method="POST" class="d-none">
                            @csrf
                        </form>
                    </div>
                </li>
            ...
            <div class="sidebar">
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-header">Mis Actividades</li>
                        <li class="nav-item">
