...
<head>
    ...
    <meta name="description" content="Restablecer contraseña en Its Fashion">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <title>Its Fashion | Restablecer Contraseña</title>
    ...
    <div class="w-11/12 max-w-[90vw] bg-white rounded-[2rem] shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[500px]">
        ...
        <div class="md:w-5/12 relative hidden md:flex flex-col justify-between overflow-hidden">
            ...
            <div class="relative z-10 p-12 mt-auto">
                <h2 class="text-4xl font-serif font-bold text-white mb-6 leading-tight">Actualiza tu<br>contraseña de acceso</h2>
                <p class="text-gray-300 font-light text-sm leading-relaxed mb-8">
                    Crea una nueva contraseña segura para reestablecer el ingreso al panel de gestión y operaciones.
                </p>
        ...
        <div class="flex-1 p-8 sm:p-12 md:p-16 flex flex-col justify-center bg-white">
            <div class="w-full max-w-md mx-auto">
                ...
                <div class="mb-8 text-center md:text-left">
                    <h1 class="text-3xl font-serif font-bold text-brand-dark mb-2">Restablecer Contraseña</h1>
                    <p class="text-sm text-brand-muted font-light leading-relaxed">
                        Ingresa tu correo y define la nueva contraseña para tu cuenta de acceso.
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
                    ...
                    <!-- Password -->
                    <div class="space-y-1.5">
                        <label for="password" class="text-xs font-bold text-slate-700 uppercase tracking-wider block">Nueva Contraseña</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-4 flex items-center text-slate-400 pointer-events-none">
                    ...
                    <!-- Confirm Password -->
                    <div class="space-y-1.5">
                        <label for="password_confirmation" class="text-xs font-bold text-slate-700 uppercase tracking-wider block">Confirmar Contraseña</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-4 flex items-center text-slate-400 pointer-events-none">
                                <i class="fas fa-shield-alt text-sm"></i>
                            </span>
                            <input type="password" id="password_confirmation" name="password_confirmation" required
                                class="w-full pl-11 pr-4 py-3 bg-slate-50 border-2 border-slate-100 rounded-2xl text-sm text-slate-700 placeholder-slate-400 focus:outline-none focus:border-brand-accent focus:bg-white transition-all duration-200 @error('password_confirmation') border-red-300 focus:border-red-500 @enderror"
                                placeholder="••••••••">
                        </div>
